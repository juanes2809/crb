...
\textbf{(b) Conservaci\'on de masa:} $\sum_j S_j(t_0)\approx1$ (l\'inea plana) para
\emph{todo} $\tau$ --- la masa se traspasa entre bins pero se conserva; \'este es
el criterio de validez, no el parecido visual. \textbf{(c) Derivada:}
