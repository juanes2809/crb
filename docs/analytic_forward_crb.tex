...
simulador realiza sobre $\sim\!5000$ tri\'angulos densificados; por eso
densificamos a $T=512$, con lo que la cuadratura \emph{converge} (los cambios de
$128$ a $512$ y a $2048$ tri\'angulos son $<0.5\%$) y la magnitud del CRB coincide
...
$\sigma_\rho^{\mathrm{an}}/\sigma_\rho^{\mathrm{FD}}\in[1.00,1.09]$ y
$\sigma_\varphi^{\mathrm{an}}/\sigma_\varphi^{\mathrm{FD}}\in[1.02,1.12]$
...
rejilla en \textbf{ambos} ejes ($\sigma_\rho$ y $\sigma_\varphi$ anal./FD
$\in[1.00,1.12]$), lo que antes era imposible con la faceta puntual. Archivo
...
\begin{enumerate}[nosep]
    ...
    $1.00$--$1.12$) en toda la rejilla; en el l\'imite duro
...
magnitud} con el FD en \textbf{ambos} ejes ($\sigma_\rho$ \emph{y} $\sigma_\varphi$
anal./FD $1.00$--$1.12$ en toda la rejilla) y la superposici\'on a magnitud real
coincide sin normalizar. Salvedades: la cuadratura de superficie es num\'erica pero
